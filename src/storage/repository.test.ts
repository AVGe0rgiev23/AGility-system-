...
describe('load: fresh database', () => {
  it('seeds meta, the default Config and a Library holding the standard question sets and patterns, and loads them', async () => {
    ...
    expect(result.store.library).toEqual({ patterns: seedPatterns(), questionSets: seedQuestionSets(), templates: [], calibration: [] })
